...
/* Sidenav classNames */
const  className = {
  active: `block h-screen fixed z-20 top-0 left-0 transition-all ease duration-200 w-7/12 md:w-60 bg-gray-800 text-white overflow-x-hidden`,
  inactive: `block h-screen fixed z-20 top-0 left-0 transition-all ease duration-200 w-0  bg-gray-800 text-white overflow-x-hidden`,
};
```
