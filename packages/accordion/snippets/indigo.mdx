...
export const AccordionPage = () => {
  return (
    <Accordion>
      ...
      <AccordionItem toggle="section-2">Accordion Group Item #2</AccordionItem>
      ...
      <AccordionItem toggle="section-3">Accordion Group Item #3</AccordionItem>
...
const style = {
  item: `block focus:outline-none bg-indigo-800 text-white border-b my-2 p-3`,
