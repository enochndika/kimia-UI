...
const style = {
  ...
  content: `animate-modal-top relative flex flex-col bg-white pointer-events-auto`,
  orientation: `mt-12 mx-8 pb-6 md:m-auto md:w-6/12 lg:w-4/12 md:pt-12`,
    ...
    {isOpen && (
      <>
        ...
        <div className={style.container}>
          <div className={style.orientation} role="dialogue" aria-modal={true}>
