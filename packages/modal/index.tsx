...
const style = {
  ...
  orientation: {
    ...
    top: 'mt-12 mx-8 pb-6 md:m-auto md:w-6/12 lg:w-4/12 md:pt-12',
    large: 'mt-12 mx-8 pb-6 md:m-auto md:w-8/12 lg:w-8/12 md:pt-12',
    extraLarge: 'mt-12 mx-8 pb-6 md:w-12/12 md:pt-12',
  },
