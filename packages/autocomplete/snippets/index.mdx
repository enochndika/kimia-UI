...
const style = {
  ...
  label: `text-gray-700`,
  option: {
    list: `shadow-xl absolute top-full left-0 right-0 border w-auto md:max-w-xs overflow-y-auto max-h-80 mt-4 bg-white p-3 z-20`,
    item: `px-4 py-3 focus text-sm text-gray-700 cursor-pointer hover:bg-gray-100`,
  },
};

const Autocomplete = ({ options, value, name, label, setValue, ...rest }) => {
  ...
  if (showOptions && value) {
    if (filteredOptions && filteredOptions.length !== 0) {
      ...
      optionList = (
        <div ref={ref} className="mt-4 text-sm text-gray-700">
