        ...
        <div className="text-gray-800">
          ...
          <ul className="list-inside mb-8">
            ...
            <li className="mb-3">
              ...
              <span className="text-sm pl-1">( string ) label for field</span>
            </li>
            <li className="mb-3">
              <Code variant="default">name</Code>
              <span className="text-sm pl-1">( string ) name of the field</span>
            </li>
            <li>
          ...
          <div>
            For a better accessibility ( a11y ), when a field is required, add
            the
            <Code variant="default">aria-required</Code> attribute to true and
            when a field is not valid add the
            <Code variant="default">aria-invalid</Code> attribute to true
          </div>
        </div>
        <DefaultFieldExample />
